export const infoConfig = {
  ...
  githubUsername: 'YcxBJ80',
  
  // Social Links
  socialLinks: [
    {
      name: 'GitHub',
      url: 'https://github.com/YcxBJ80',
      icon: 'github'
    },
    {
      name: 'Bilibili',
  ...
  // Blog Config
  blogHeadLine: 'Tech Blog',
  blogIntro: 'Sharing AI learning insights, project experiences, and cutting-edge technology news',

  // Project Config  
  projectHeadLine: 'Research & Projects',
  projectIntro: 'Showcasing our latest AI research projects and innovative applications'
}
