...
export function AuthButton() {
  ...
  return (
    <div className="relative">
      ...
      {showDropdown && (
        <div className="absolute right-0 mt-2 w-56 bg-card rounded-xl shadow-lg border border-border/50 py-2 z-50 backdrop-blur-sm">
          {/* 用户信息 */}
          <div className="px-4 py-3 border-b border-border/50">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="font-medium text-card-foreground truncate">{displayName}</div>
