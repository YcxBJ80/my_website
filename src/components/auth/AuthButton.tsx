...
import { onAuthStateChange, logoutUser } from '@/lib/auth';
...
export function AuthButton() {
  ...
  if (isLoading) {
    return (
      <div className="bg-card border border-border px-6 py-2 rounded-xl">
  ...
  return (
    <div className="relative">
      ...
      {showDropdown && (
        <div className="absolute right-0 mt-2 w-64 bg-card rounded-xl shadow-lg border border-border/50 py-2 z-50 backdrop-blur-sm">
          {/* User Info */}
          ...
          <div className="py-1">
            <Link
              href="/auth"
              className="flex items-center px-4 py-2 text-sm text-card-foreground hover:bg-accent hover:text-accent-foreground transition-colors"
          ...
          <div className="border-t border-border/50 py-1">
            <button
              ...
              className="flex items-center w-full px-4 py-2 text-sm text-morandi-pink hover:bg-morandi-pink-light transition-colors"
            >
              <svg className="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
